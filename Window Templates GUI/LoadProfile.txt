...
static TCHAR windowsTitle[] = _T("Load Profile Screen");

//Window Instance
HINSTANCE hInst;
//Creation of a handle for the window
HWND addProgramButton, deleteProgramButton, currentUserTextbox, currentProfileTextbox, listOfApplicationsTextbox;
...
//Button Proc test
WNDPROC addProgramButtonProc, deleteProgramButtonProc, currentUserTextboxProc, currentProfileTextboxProc, listOfApplicationsTextboxProc;
...
LRESULT CALLBACK ButtonProc(HWND hwnd, UINT msg, WPARAM wp, LPARAM lp)
{
	...
	return CallWindowProc(addProgramButtonProc, hwnd, msg, wp, lp);
}
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	TCHAR listOfApplications[] = _T("List Of Applications:");
	...
	case WM_CREATE:
	{
		...
		//Add Program Button
		HWND addProgramButton = CreateWindow(TEXT("button"), TEXT("Add Program"),
			WS_VISIBLE | WS_CHILD | BS_PUSHBUTTON,
			210, 370, 120, 20,
			hWnd, NULL, NULL, NULL);
		//Button Proc (what it will do)
		addProgramButtonProc = (WNDPROC)SetWindowLong(addProgramButton, GWL_EXSTYLE, (LONG)ButtonProc);

		//Delete Program Button
		HWND deleteProgramButton = CreateWindow(TEXT("button"), TEXT("Delete Program"),
			WS_VISIBLE | WS_CHILD | BS_PUSHBUTTON,
			340, 370, 120, 20,
			hWnd, NULL, NULL, NULL);
		//Button Proc (what it will do) 
		deleteProgramButtonProc = (WNDPROC)SetWindowLong(deleteProgramButton, GWL_EXSTYLE, (LONG)ButtonProc);
		...
		HWND listOfApplicationsTextbox = CreateWindow(TEXT("EDIT"), TEXT(""),
			WS_BORDER | WS_CHILD | WS_VISIBLE,
			50, 150, 400, 200,
			hWnd, NULL, NULL, NULL);
	...
	case WM_PAINT:
		...
		TextOut(hdc,
			50, 130,
			listOfApplications, _tcsclen(listOfApplications));
